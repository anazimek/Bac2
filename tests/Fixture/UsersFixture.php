...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'github_username' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'username' => ['type' => 'unique', 'columns' => ['username', 'email', 'phone', 'github_username'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
