var ComponentsDropdowns = function () {
    var e = function () {
        ...
        $("#select2_sample1").select2({
        ...
        }), $("#select2_sample5").select2({tags: ["red", "green", "blue", "yellow", "pink"]}), $("#select2_sample6").select2({
            ...
            ajax: {
                ...
                dataType: "jsonp",
                data: function (e, t) {
                    return {q: e, page_limit: 10, apikey: "ju6z9mjyajq2djue3gbvv26t"}
                },
            ...
            initSelection: function (e, t) {
                var s = $(e).val();
                "" !== s && $.ajax("http://api.rottentomatoes.com/api/public/v1.0/movies/" + s + ".json", {
                    data: {apikey: "ju6z9mjyajq2djue3gbvv26t"},
                    dataType: "jsonp"
                }).done(function (e) {
                    t(e)
                })
        ...
        $("#select2_sample_modal_1").select2({
            ...
            allowClear: !0, minimumInputLength: 1, query: function (e) {
                var t, s, l, o = {results: []};
                for (t = 1; 5 > t; t++) {
                    for (l = "", s = 0; t > s; s++)l += e.term;
                    o.results.push({id: e.term + t, text: l})
        ...
        }), $("#select2_sample_modal_5").select2({tags: ["red", "green", "blue", "yellow", "pink"]}), $("#select2_sample_modal_6").select2({
            placeholder: "Search for a movie",
            minimumInputLength: 1,
            ajax: {
                url: "http://api.rottentomatoes.com/api/public/v1.0/movies.json",
